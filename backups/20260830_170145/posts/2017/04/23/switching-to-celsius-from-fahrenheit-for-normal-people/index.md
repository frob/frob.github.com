...
| key | value |
| --- | --- |
| url | https://www.frobiovox.com/posts/2017/04/23/switching-to-celsius-from-fahrenheit-for-normal-people/ |
| date | 2017-04-23 |
...
<td align="left">It is frozen, wear a jacket and possibly thermals. The further below 0 °C the more warm clothes you need to wear.</td>
</tr>
<tr>
<td align="center">0 °C to 10 °C</td>
<td align="left">It's cold, but not freezing. Wear a jacket.</td>
</tr>
<tr>
...
Fahrenheit was a scale that (to the best of our knowledge) was derived by 0 °F being a stable solution of ice, water, and ammonium chloride, and the temperature of a healthy human being 96 °F. In the final standard of the scale the healthy human ended up being 98.6 °F and freezing water at sea level was 32 °F.
...
Celsius (also called centigrade) is a scale of temperature that is based on water at sea level. In Celsius, 100 °C is boiling and 0 °C is freezing. If you would like more information on Celsius, read the [wikipedia article on Celsius](https://en.wikipedia.org/wiki/Celsius). 

Celsius went under some revisions and refinement as the scale centigrade, but in 1948 it was officially renamed Celsius to honor the person who originally thought of it in 1742.

## Why switch

Conformity is a good argument, but it isn't the argument I would use for this. Even though the vast majority of the world uses Celsius, I would say the reason to switch is because it makes more sense and it is easier to see whether or not it is comfortable outside. Refer to the table at the beginning. If it's over 30 °C it's too hot, if it is under 10 °C then it's too cold.

## Fahrenheit to Celsius Math conversion

This conversion is why I say, just switch outright. Don't worry about converting. Nearly everything that tells you the temperature can be set to the unit of your choice. If you want to convert this is the official accurate calculation: \[°F\] = \[°C\] ×  9⁄5 + 32
...
That's it, empower yourself. Celsius is easy. Just do it!
