...
| key | value |
| --- | --- |
| url | https://www.frobiovox.com/posts/2015/05/04/setting-a-default-value-for-a-link-or-url-field-in-drupal-7/ |
| date | 2015-05-04 |
...
If you were to run a dpm on the $form callback you would find several interesting array items.
...
## #columns
This is where the #columns item comes into play. Inside the #columns item there are sub-items that tell you what values you need to set inside of the #default_value item. Get all that?

### For example:
The #columns element should look like this for a link field element.
...
This should hold true for all fields of all types. I noticed this when I stumbled upon this [Drupal.org issue where someone was asking how to set the default value of a link field.](https://www.drupal.org/node/1782516#comment-7552205)

The issue didn't talk about this behavior of the #columns item. I just noticed it when digging through that. Cool eh?
