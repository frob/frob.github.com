...
| key | value |
| --- | --- |
| url | https://www.frobiovox.com/posts/2013/10/06/support-should-not-be-based-on-marketshare/ |
| date | 2013-10-06 |
...
The question "which browsers do we support?" comes up on every project, and the answer is almost always based on market share. I think that is the wrong approach. Here is why.
...
The bottom line: support should be based on what features a browser can handle, not on how many people use it. Build for capability, enhance progressively, and let the browsers do what they were designed to do -- their best.
