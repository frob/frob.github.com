# create some dynamic elements to jekyll on github pages with reactjs

| key | value |
| --- | --- |
| url | https://www.frobiovox.com/posts/2015/10/25/create-some-dynamic-elements-to-jekyll-on-github-pages-with-reactjs/ |
| date | 2015-10-25 |
