---
title: Introducing v; the easiest vendor utility
date: "2026-08-29"
...
slug: introducing-v-the-easiest-vendor-utility
tags:
    - git
    - open source
    - tutorial
...
Vendoring dependencies is awsome. It is more secure and stable than any package manager. But if I am being honest, most of the time you should just use the expected case package manager. If your language has a package manager and your dependency is published to it, use the package manager. That is what it is for.
